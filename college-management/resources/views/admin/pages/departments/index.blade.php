            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-admin.phead title="Departments" subtitle="Manage all of departments from here.">
                                    ...
                                    @foreach ($departments as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                {{-- View --}}
                                                <a href="{{ route('departments.show', ['department' => $item->id]) }}"
                                                    class="btn btn-sm btn-outline-info">
                                                    <i class="mdi mdi-eye"></i>
                                                </a>

                                                {{-- Edit --}}
                                                <a href="{{ route('departments.edit', ['department' => $item->id]) }}"
