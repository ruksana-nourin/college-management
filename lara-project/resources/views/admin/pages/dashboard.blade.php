...
@section('content')
    ...
    <x-admin.phead title="Dashboard" subtitle="Welcome to Spark Admin Dashboard">
                            ...
                            <div class="card-header">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-arrow-repeat"></i>
                                                Refresh</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="bi bi-file-earmark-arrow-down"></i>
                                                Export
                                                Report</a></li>
                                        <li>
                                            <hr class="dropdown-divider">
                                        </li>
                                        <li><a class="dropdown-item text-danger" href="#"><i class="bi bi-eye-slash"></i>
                                                Hide Details</a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="card h-100 flex-grow-1">
                        <div class="card-header">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                                    <li><a class="dropdown-item" href="#"><i class="bi bi-funnel"></i> Filter
                                            Status</a></li>
                                    <li><a class="dropdown-item" href="#"><i class="bi bi-file-earmark-arrow-down"></i>
                                            Export CSV</a>
                                    </li>
                    ...
                    <div class="card h-100 flex-grow-1">
                        <div class="card-header">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-custom">
                                    <li><a class="dropdown-item" href="#"><i class="bi bi-plus-lg"></i> Add
                                            Product</a></li>
                        ...
                        <div class="progress-container">
                            ...
                            <div class="progress" role="progressbar" aria-label="Product Launched Progress"
                        ...
                        <div class="progress-container">
                            ...
                            <div class="progress" role="progressbar" aria-label="Ongoing Product Progress"
                        ...
                        <div class="progress-container">
                            ...
                            <div class="progress" role="progressbar" aria-label="Product Returned Progress"
                        ...
                        <div class="progress-container">
                            ...
                            <div class="progress" role="progressbar" aria-label="Product In Stock Progress"
                        ...
                        <div class="progress-container">
                            ...
                            <div class="progress" role="progressbar" aria-label="Pending Shipment Progress"
